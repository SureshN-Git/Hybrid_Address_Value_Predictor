...
public:
  ...
  uint64_t count;
	...
	struct activeList {
		...
		uint64_t logicalRegister;
		uint64_t physicalRegister;
		uint64_t ready;
		uint64_t exception;
		uint64_t loadViolationBit;
		uint64_t branchMispredictionBit;
		uint64_t valueMispredictionBit;
		bool loadFlag;
		bool storeFlag;
		bool branchFlag;
		bool amoFlag;
...
//	uint64_t numOfFreeRegister();
	...
	//support Method
	//uint64_t numberOfEmptyBranchSpace();
	/////////////////////////////////////////////////////////////////////
	...
	//supporting Method
//	uint64_t numOfFreeActiveListRegister();
