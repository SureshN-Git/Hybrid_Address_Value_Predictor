...
unsigned int payload::push() {
	...
	index = tail;
	buf[index].set_complete_counter = 0; /**/
	buf[index].is_addr_pred = 0; /**/
	buf[index].not_confident = 0; /**/
	buf[index].mpt_hit = 0; /**/
...
void payload::pop() {
	...
	//buf[head].set_complete_counter = 0; /**/
	//buf[head].is_addr_pred = 0; /**/
	//buf[head].mpt_hit = 0; /**/
